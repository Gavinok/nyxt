...
When suggestions are marked, subsequent `return-actions' run over all marked
suggestions.
...
of this source.
This is the low-level implementation, see the `return-actions' function for the public
interface.")
...
See `resume-sources'.")
   ...
   (auto-selection-action-p nil
                            :type boolean
                            :documentation
                            "Whether the first of `selection-actions' runs automatically.
Also see `auto-return-selection-action-delay'.")

   (auto-return-selection-action-delay 0.0
                                       :documentation
                                       "Execute the first of `selection-actions'
after this delay when `auto-selection-action-p' is non-nil.")
